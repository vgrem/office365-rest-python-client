...
def main():
    parser = argparse.ArgumentParser(description="Apply a site design to a site")
    ...
    task = SiteScriptUtility.add_site_design_task(ctx, args.site_url, str(target.Id)).execute_query()

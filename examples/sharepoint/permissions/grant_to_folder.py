"""
Grant a user permissions on a folder.
...
folder.add_role_assignment(test_user_principal_name, RoleType.Contributor).execute_query()
print("Access granted on folder")

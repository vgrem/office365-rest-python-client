"""Demonstrates how to create a Text (single line) field in a list
...
field = lib.fields.add_text_field("Notes").execute_query()
print(f"Text field created: {field.internal_name}")

"""
Sets the external sharing capability for a site.
...
def sharing_label(cap):
    """Return a human-readable label for a sharing capability."""
    if cap is None:
        return "Unknown"
...
props.update_ex().execute_query()
print(f"Updated: {sharing_label(props.sharing_capability)}")

...
abs_file_url = "{site_url}/sites/team/Shared Documents/archive/big_buck_bunny.mp4".format(site_url=test_site_url)
...
with tempfile.TemporaryDirectory() as local_path:
    ...
    print("'{0}' file has been downloaded into {1}".format(file.server_relative_path, local_file.name))

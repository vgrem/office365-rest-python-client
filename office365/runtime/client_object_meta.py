...
) -> Callable[[Callable[..., PropertyT]], Callable[..., PropertyT]]:
    """Decorator to automatically track property access for persistence"""

    def decorator(method: Callable[..., PropertyT]) -> Callable[..., PropertyT]:
        def wrapper(self: ClientObject, *args: Any, **kwargs: Any) -> PropertyT:

...
from office365.intune.print.services.endpoint import PrintServiceEndpoint
from office365.runtime.paths.resource_path import ResourcePath


class PrintService(Entity):
    """Represents an Azure AD tenant-specific description of a print service instance.
    Services exist for each component of the print infrastructure (discovery, notifications, registration, and IPP)

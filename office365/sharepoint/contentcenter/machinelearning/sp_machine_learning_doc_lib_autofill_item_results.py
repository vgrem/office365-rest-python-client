...
class SPMachineLearningDocLibAutofillItemResults(ClientValue):
    Failed: ClientValueCollection = field(default_factory=ClientValueCollection)
    NoText: ClientValueCollection = field(default_factory=ClientValueCollection)
    ...
    def entity_type_name(self) -> str:
        return "Microsoft.Office.Server.ContentCenter.SPMachineLearningDocLibAutofillItemResults"

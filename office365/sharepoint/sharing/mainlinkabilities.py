...
from office365.sharepoint.sharing.linkexpirationabilitystatus import SharingLinkExpirationAbilityStatus
from office365.sharepoint.sharing.mainlinkaudienceabilities import MainLinkAudienceAbilities

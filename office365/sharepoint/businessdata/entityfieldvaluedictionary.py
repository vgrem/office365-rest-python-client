...
class EntityFieldValueDictionary(Entity):
    ...
    def get_collection_size(self, field_dot_notation: str) -> ClientResult[int]:
        """GetCollectionSize operation.
        ...
        qry = ServiceOperationQuery(
            self, "GetCollectionSize", None, {"fieldDotNotation": field_dot_notation}, None, return_type
        )
        self.context.add_query(qry)
        return return_type

...
class SortCollection(Entity):
    ...
    def add(self, property_name: str, direction: int):
        ...
        Args:
            property_name (str): f direction is equal to SortDirection.Ascending or SortDirection.Descending, then this element specifies the name of the managed property to sort the search results on

...
class RegionalSettings(Entity):
    ...
    @property
    def collation_lcid(self) -> Optional[int]:
    ...
    @property
    def first_week_of_year(self) -> Optional[int]:
    ...
    @property
    def is_ui_right_to_left(self) -> Optional[bool]:
    ...
    @property
    def list_separator(self) -> Optional[str]:

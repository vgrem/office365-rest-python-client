...
class CalendarRoleType(Enum):
    ...
    read = 3
    "User is a sharee who can view all the details of the events on the calendar, except for the owner's private events"
    write = 4
    ...
    "User is a delegate who has write access but cannot view information of the owner's private events on the calendar"
    ...
    def entity_type_name(self):
        return "microsoft.graph.CalendarRoleType"

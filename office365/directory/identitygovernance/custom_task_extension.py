...
class CustomTaskExtension(Entity):
    ...
    def callback_configuration(self) -> CustomExtensionCallbackConfiguration:
        ...
        return self.properties.get('callbackConfiguration', None)
    ...
    def last_modified_by(self) -> User:
        ...
        return self.properties.get('lastModifiedBy', User(self.context, ResourcePath('lastModifiedBy', self.resource_path)))

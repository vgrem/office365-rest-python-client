...
from office365.reports.userregistration.feature_summary import UserRegistrationFeatureSummary
...
class AuthenticationMethodsRoot(Entity):
    ...
    def users_registered_by_feature(self) -> ClientResult[UserRegistrationFeatureSummary]:
    ...
    def user_registration_details(self) -> EntityCollection[UserRegistrationDetails]:
        ...
        return self.properties.get(
            ...
            EntityCollection(
                self.context, UserRegistrationDetails, ResourcePath("userRegistrationDetails", self.resource_path)
            ),
        )

    @property
    def entity_type_name(self) -> str:
        return "microsoft.graph.AuthenticationMethodsRoot"

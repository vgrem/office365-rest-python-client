...
class TestDevices(GraphDelegatedTestCase):
    ...
    @requires_delegated_permission_or_role(
        "Device.Read.All", "Directory.Read.All", "Directory.ReadWrite.All", roles=["Global Administrator"]
    )
    ...
    @requires_delegated_permission_or_role("Directory.AccessAsUser.All", roles=["Global Administrator"])
    ...
    @requires_delegated_permission_or_role(
        "Device.Read.AllDirectory.Read.All", "Directory.ReadWrite.All", roles=["Global Administrator"]
    )

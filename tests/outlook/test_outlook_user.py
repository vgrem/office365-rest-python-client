...
class TestOutlookUser(GraphTestCase):
    ...
    @requires_delegated_permission_or_role(
        "Mail.Read", "Mail.Read.Shared", roles=["Exchange Administrator", "Global Administrator"]
    )
    ...
    @requires_delegated_permission_or_role(
        "MailboxSettings.ReadWrite", roles=["Exchange Administrator", "Global Administrator"]
    )
    ...
    @requires_delegated_permission_or_role(
        "MailboxSettings.Read", "MailboxSettings.ReadWrite", roles=["Exchange Administrator", "Global Administrator"]
    )

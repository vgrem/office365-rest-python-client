...
_BS_READ = ("BackupRestore.Read.All",)
_BS_WRITE = ("BackupRestore.ReadWrite.All",)
_BS_CONTROL = ("BackupRestore-Control.ReadWrite.All",)
# Test tenant for backup restore operations
...
class TestBackupRestoreServiceStatus(GraphDelegatedTestCase):
    ...
    @requires_delegated(*_BS_READ, bypass_roles=["Global Administrator"])
...
class TestBackupRestoreEnable(GraphDelegatedTestCase):
    ...
    @requires_delegated(*_BS_CONTROL, bypass_roles=["Global Administrator"])
...
class TestBackupRestoreProtectionPolicies(GraphDelegatedTestCase):
    ...
    def test_01_list_one_drive_policies(self):
        ...
        result = (
            self.client.solutions.backup_restore.one_drive_for_business_protection_policies.top(10)
            .get()
            .execute_query()
        )
        self.assertIsNotNone(result.resource_path)
    ...
    def test_02_policy_has_expected_properties(self):
        ...
        result = (
            self.client.solutions.backup_restore.one_drive_for_business_protection_policies.top(5)
            .get()
            .execute_query()
        )
        if len(result) == 0:
    ...
    def test_03_policy_filter_by_status(self):
        ...
        result = (
            self.client.solutions.backup_restore.one_drive_for_business_protection_policies.filter(
                "status eq 'active'"
            )
            .top(5)
            .get()
    ...
    def test_04_policy_has_drive_inclusion_rules(self):
        ...
        result = (
            self.client.solutions.backup_restore.one_drive_for_business_protection_policies.top(3)
            .get()
            .execute_query()
        )
        if len(result) == 0:
    ...
    def test_05_get_policy_by_id(self):
        ...
        result = (
            self.client.solutions.backup_restore.one_drive_for_business_protection_policies.top(1)
            .get()
            .execute_query()
        )
        if len(result) == 0:
